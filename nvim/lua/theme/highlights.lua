-- Highlight definitions for custom theme
-- Based on techbase highlight groups

local M = {}

-- Helper function to tint colors (darken/lighten)
local function tint(color, amount)
  -- Simple tint implementation - can be enhanced later
  return color
end
